...
let licensePlate = ['ABC123', 'XYZ789', 'LMN456']; 
...
let positionsArray = charactersArray.map((char) => {let lowercaseChar = char.toLowerCase();
    switch (positionsArray) {
        case 'a':
            return 1;
        case 'b':
            return 2;
